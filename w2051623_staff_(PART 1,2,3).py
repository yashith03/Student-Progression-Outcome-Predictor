...
while True:
    ...
    print("Would you like another set of data ? ")#asking for another set of data
...
# Calculating heights of the histogram
...
def main():
    ...
    Xaxis = Line(Point(50,510),Point(750,510))#x axis 
    Xaxis.setWidth(2)
    Xaxis.draw(win)
    ...
    Prog = Rectangle(Point(100,485),Point(200,485-HeightP))#progress bar
    Prog.setFill("blue3")
    ...
    Prog_Mod_Trailer = Rectangle(Point(335,485), Point(235,485-HeightT))#progress module trailer bar
    ...
    DN_Progress = Rectangle(Point(470,485), Point(370,485-HeightR))#Do not progress(module retriever bar)
    ...
    Exclude = Rectangle(Point(505,485), Point(605,485-HeightE))#exclude bar
